...
/**
 * Generate descriptions for all remaining bookshops
 * Node.js-compatible version using process.env
 */
...
if (!ANTHROPIC_API_KEY) {
  console.error('❌ Anthropic API key not found. Set VITE_ANTHROPIC_API_KEY');
  process.exit(1);
}
...
async function generateAllRemaining() {
  ...
  // PHASE 1: Fix the failed validations
